// Todo List App - Vanilla JavaScript implementation
// Based on The Elm Architecture (TEA) pattern
...
// initial_model defines the default state of the application
var initial_model = {
  todos: [],  // empty list of todo items
  hash: "#/"  // default route - show all items
}
...
function subscriptions (signal) {
	var ENTER_KEY = 13; // [Enter] key - confirms adding or saving a todo item
var ESCAPE_KEY = 27; // [Esc] key - cancels editing a todo item
